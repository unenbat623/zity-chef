...
const INGREDIENT_IMAGE_MAP: Record<string, string> = {
  ...
  өндөг:
    'https://images.unsplash.com/photo-1491524062933-cb0289261700?w=400&q=75&auto=format&fit=crop',
  сонгино:
    'https://images.unsplash.com/photo-1508747703725-719777637510?w=400&q=75&auto=format&fit=crop',
  ...
  бяслаг:
    'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=400&q=75&auto=format&fit=crop',
  том: 'https://images.unsplash.com/photo-1546470427-0d4b8e6a3e4c?w=400&q=75&auto=format&fit=crop',
  'улаан лооль':
    'https://images.unsplash.com/photo-1546470427-0d4b8e6a3e4c?w=400&q=75&auto=format&fit=crop',
  мөөг: 'https://images.unsplash.com/photo-1517805686688-47dd930554b2?w=400&q=75&auto=format&fit=crop',
  'буудайн талх':
    'https://images.unsplash.com/photo-1534620808146-d33bb39128b2?w=400&q=75&auto=format&fit=crop',
  тосон:
    'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400&q=75&auto=format&fit=crop',
  чинжүү:
    'https://images.unsplash.com/photo-1590005354167-6da97870c757?w=400&q=75&auto=format&fit=crop',
  часнай:
    'https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?w=400&q=75&auto=format&fit=crop',
  самар:
    'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400&q=75&auto=format&fit=crop',
  ...
  onion:
    'https://images.unsplash.com/photo-1508747703725-719777637510?w=400&q=75&auto=format&fit=crop',
  apple:
    'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=400&q=75&auto=format&fit=crop',
  flour:
    'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&q=75&auto=format&fit=crop',
  cheese:
    'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=400&q=75&auto=format&fit=crop',
  tomato:
    'https://images.unsplash.com/photo-1546470427-0d4b8e6a3e4c?w=400&q=75&auto=format&fit=crop',
  mushroom:
    'https://images.unsplash.com/photo-1517805686688-47dd930554b2?w=400&q=75&auto=format&fit=crop',
  pepper:
    'https://images.unsplash.com/photo-1590005354167-6da97870c757?w=400&q=75&auto=format&fit=crop',
  garlic:
    'https://images.unsplash.com/photo-1540148426945-6cf22a6b2383?w=400&q=75&auto=format&fit=crop',
  ...
  butter:
    'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400&q=75&auto=format&fit=crop',
  salmon:
    'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=400&q=75&auto=format&fit=crop',
  shrimp:
    'https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?w=400&q=75&auto=format&fit=crop',
};
